...
| 2026-05-08 | 보고서 가독성 + watchlist 섹션 강제 + 출처 표기 정확화 | report-writer + report-template + workflow direct_prompt | 첫 RSS 기반 보고서에서 watchlist 섹션 누락 + 불릿 과다 + 출처가 "Google News RSS" 일괄 표기 문제 발견. (1) writer 작업 원칙에 서술형 3단락 구조 강제(사실/영향/반사실), (2) watchlist 섹션 통째 생략 금지(0건이어도 헤더 + 1줄), 게재 기준은 Tier 1-2 매체 2개+ 일치(사용자 "겹치는 것만 올림" 요구), (3) 출처는 source 필드 매체명 + raw_news.link URL 그대로 사용 |
